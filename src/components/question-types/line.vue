      ...
      <div class="pl-astable-col">
        <div class="pl-linebox">
          <div class="pl-astable xline">
            ...
            <div class="pl-astable-row xline-tools">
              <div class="pl-astable-col">
                <a class="pl-addoptionbtn"><i class="pl-ico xadd2"></i>增加列</a>
              </div>
              <div class="pl-astable-col">
                <a class="pl-addoptionbtn"><i class="pl-ico xadd2"></i>增加选项</a>
              </div>
              <div class="pl-astable-col">
                <a class="pl-addoptionbtn xweeking"><i class="pl-ico xdel"></i>删除最后选项</a>
              </div>
            </div>
          </div>
        </div>
